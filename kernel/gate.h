...
inline static void set_system_intr_gate(unsigned int n, unsigned char ist, void *addr) {
    _set_gate(IDT_Table + n, 0xEE, ist, addr);
}

void set_tss64(unsigned long rsp0, unsigned long rsp1, unsigned long rsp2, unsigned long ist1,
